...
/// Determine the position of a `Coordinate` relative to a geometry.
///
/// # Examples
///
/// ```rust
...
impl<T> CoordinatePosition<T> for Coordinate<T>
where
    T: HasKernel,
{
    fn calculate_coordinate_position(
    ...
    T: HasKernel,
{
    fn calculate_coordinate_position(
        ...
        Polygon::from(self.clone()).calculate_coordinate_position(coord, is_inside, boundary_count);
    }
}
...
impl<T> CoordinatePosition<T> for MultiPoint<T>
where
    T: HasKernel,
{
    fn calculate_coordinate_position(
...
impl<T> CoordinatePosition<T> for MultiLineString<T>
where
    T: HasKernel,
{
    fn calculate_coordinate_position(
...
impl<T> CoordinatePosition<T> for GeometryCollection<T>
where
    T: HasKernel,
{
    fn calculate_coordinate_position(
...
impl<T> CoordinatePosition<T> for Geometry<T>
where
    T: HasKernel,
{
    fn calculate_coordinate_position(
